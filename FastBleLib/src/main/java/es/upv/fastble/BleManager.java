...
import es.upv.fastble.bluetooth.BleBluetooth;
import es.upv.fastble.bluetooth.MultipleBluetoothController;
import es.upv.fastble.bluetooth.SplitWriter;
...
import es.upv.fastble.callback.BleScanAndConnectCallback;
...
import es.upv.fastble.data.BleScanState;
import es.upv.fastble.exception.OtherException;
import es.upv.fastble.scan.BleScanRuleConfig;
import es.upv.fastble.scan.BleScanner;
import es.upv.fastble.utils.BleLog;
