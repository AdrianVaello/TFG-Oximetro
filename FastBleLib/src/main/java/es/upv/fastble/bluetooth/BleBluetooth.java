package es.upv.fastble.bluetooth;
...
import es.upv.fastble.data.BleConnectStateParameter;
import es.upv.fastble.data.BleDevice;
import es.upv.fastble.data.BleMsg;
import es.upv.fastble.exception.ConnectException;
import es.upv.fastble.exception.OtherException;
import es.upv.fastble.exception.TimeoutException;
